/*
 * htmlEmail
 * https://github.com/vagrant/temp
 *
 * Copyright (c) 2013 Vrykolas
  ...
  grunt.initConfig({
    ...
    recess: {
      server: {
        ...
        files: {
          '<%= c.dev %>/private/.temp/stylesheets/less.css': '<%= c.dev %>/private/stylesheets/**/*.less'
        }
      }
    },
    concat: {
    ...
    watch: {
      ...
      less: {
        files: ['<%= c.dev %>/private/stylesheets/**/*.less'],
        tasks: ['less']
      },
      coffee: {
